...
def compute_all_scores(
    ...
    pec_scores = compute_agent_scores_pec(model_ds, df, class_values)
    ...
    if compute_item_details:
        ...
        item_scores_pec = compute_posterior_expected_credit(model_ds, df, class_values)
...
def compute_all_scores_with_bootstrap(
    ...
    results = compute_all_scores(df, n_classes, class_values, verbose=verbose)
